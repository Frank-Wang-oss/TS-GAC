...
from models.model_GNN_CNN import Base_model
...
def main(configs, args,lambda1, lambda2, lambda3,num_remain_aug1, num_remain_aug2):
    ...
    Trainer(model, temporal_contr_model, model_optimizer, temporal_contr_optimizer, train_dl, test_dl, device, logger, configs, experiment_log_dir, training_mode,
            lambda1, lambda2, lambda3,num_remain_aug1, num_remain_aug2)
...
if __name__ == '__main__':
    ...
    dataset_UEA = ['HAR', 'ISRUC', 'ArticularyWordRecognition', 'FingerMovements','SpokenArabicDigitsEq']
